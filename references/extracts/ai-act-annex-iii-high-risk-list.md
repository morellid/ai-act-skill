# Extract — AI Act Annex III: High-risk AI systems referred to in Article 6(2)
...
The Commission may amend this Annex by delegated acts (Art. 7) — verify against the latest consolidated version when applying.
...
- **(a)** Remote biometric identification systems. (Excluding biometric verification, the sole purpose of which is to confirm that a specific natural person is the person they claim to be.)
...
- **(a)** AI systems intended to be used to **determine access, admission, or assignment** of natural persons to educational and vocational training institutions at all levels.
...
- **(b)** AI systems intended to be used for **influencing the outcome of an election or referendum or the voting behaviour of natural persons** in the exercise of their vote in elections or referendums. This does not include AI systems to the output of which natural persons are not directly exposed, such as tools used to organise, optimise, or structure political campaigns from an administrative or logistical point of view.

---

## Notes for the skill

- Annex III is **explicitly amendable by Commission delegated acts** (Art. 7). Always verify the latest consolidated version before classification.
- Many areas have **safety-component** language (area 2 critical infrastructure) — the AI must perform a safety function or its failure must endanger health/safety, not merely operate in proximity to the area.
- Area 5(b) credit scoring excludes **fraud detection** — fraud-detection AI is not high-risk under that area but may be elsewhere.
- Area 8(b) elections **excludes back-office tools** that voters do not directly interact with.
- The Art. 6(3) derogation can apply to specific Annex III systems (narrow procedural task, improving prior human decision, detecting deviations, preparatory task) — but **profiling always remains high-risk**.
