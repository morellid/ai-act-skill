# Extract — AI Act Article 5: Prohibited AI practices
...
**Application**: from **2 February 2025** (Art. 113(a))
...
> This prohibition does not cover any labelling or filtering of lawfully acquired biometric datasets, such as images, based on biometric data or categorising of biometric data in the area of law enforcement.
...
The use of 'real-time' remote biometric identification systems in publicly accessible spaces for the purposes of law enforcement for any of the objectives referred to above shall be deployed only to confirm the identity of the specifically targeted individual and shall take into account the seriousness, probability and scale of the harm that would be caused if the system were not used, and the consequences for the rights and freedoms of all persons concerned.

Each use is subject to:
- a **prior authorisation** by a judicial authority or by an independent administrative authority of the Member State, granted upon a reasoned request and in accordance with detailed national rules (with limited exception in case of duly justified urgency, where authorisation may be requested ex post within 24 hours);
- a **fundamental rights impact assessment** under Article 27;
- **registration** in the EU database referred to in Article 71;
- compliance with the requirements set out in Article 26;
- a **Member State enabling national law** that permits the practice within the limits of this Article (Member States can choose not to enable it).

---

## Penalties (Art. 99(3))

Non-compliance with the prohibitions in Article 5 is subject to the **highest tier of fines**: up to **EUR 35 000 000** or, if the offender is an undertaking, up to **7% of its total worldwide annual turnover for the preceding financial year**, whichever is higher.

---

## Notes for the skill

- Prohibited practices apply since **2 February 2025**. They are in force.
