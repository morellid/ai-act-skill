...
>
> **Article 50 transparency is in force since 2 August 2026.** Regulation (EU) 2026/1744 (Digital Omnibus on AI, OJ 24 July 2026, in force 27 July 2026) deferred only the Chapter III high-risk dates — **2 December 2027** for stand-alone Annex III systems and **2 August 2028** for safety components of Annex I products. It did **not** defer Article 50. The single transitional relief is for the Art. 50(2) marking and detection duty on generative systems placed on the market before 2 August 2026, which have until **2 December 2026**. The same Regulation adds **Article 5(1) points (ba) and (bb)**, prohibiting AI systems generating non-consensual intimate imagery ("nudifier apps") and child sexual abuse material, applicable from **2 December 2026**; the new Article 5(1a) makes safeguards relevant only where the prohibited output is a foreseeable outcome, not where it is the system's intended purpose. Article 4 (AI literacy) and the pre-existing Article 5 prohibitions — in force since 2 February 2025 — and Chapter V GPAI obligations — in force since 2 August 2025 — are unaffected.
